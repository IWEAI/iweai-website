...
export const siteConfig: SiteConfig = {
  ...
  location: {
    city: 'City Name',                 // ← CHANGE: Host city
    country: 'Country Name',           // ← CHANGE: Host country
  },
  dates: 'DD-DD Month YYYY',           // ← CHANGE: e.g. "17-18 November 2026"

  // ── Contact & partner links ──────────────────────────────────────
  email: 'iweai2026@outlook.com',      // ← CHANGE: Year-specific contact email
  pricaiUrl: 'https://pricai.org/2026/',            // ← CHANGE
  pricaiLabel: 'PRICAI2026',           // ← CHANGE: Label shown in nav bar
  attendingUrl: 'https://www.pricai.org/2026/attending', // ← CHANGE: Link for "ATTENDING" nav item
  ...
  // ── Important dates ──────────────────────────────────────────────
  importantDates: {
    abstractDeadline: 'Month DD, YYYY',  // ← CHANGE
    acceptance: 'Month DD, YYYY',        // ← CHANGE
    cameraReady: 'Month DD, YYYY',       // ← CHANGE
    workshop: 'Month DD-DD, YYYY',       // ← CHANGE
